...
public:
	...
	void			SetImageTransformMode(ImageTransformMode tm_mode);
...
protected:
	static bool		GetImageDrawRect(UINT target_width, UINT target_height, 
									 UINT image_width, UINT image_height, D2D1_RECT_F& dst_rect,
									 ImageTransformMode tm_mode);
